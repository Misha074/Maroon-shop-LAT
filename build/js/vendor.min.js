...
function initSwiperRecently() {
  if (document.querySelector('.swiper-recently') !== null) {
    var swiperPrev1 = document.querySelector('[data-swiper-recently-prev]');
    var swiperNext1 = document.querySelector('[data-swiper-recently-next]');
    var swiper1 = new Swiper('.swiper-recently', {
...
function initSwiperCognate() {
  if (document.querySelector('.swiper-cognate') !== null) {
    var swiperPrev2 = document.querySelector('[data-swiper-cognate-prev]');
    var swiperNext2 = document.querySelector('[data-swiper-cognate-next]');
    var swiper2 = new Swiper('.swiper-cognate', {
      direction: 'horizontal',
      slidesPerView: 1,
      loop: true,
      breakpoints: {
...
function initSwiperBestsellers() {
  if (document.querySelector('.swiper-bestsellers') !== null) {
    var swiperPrev3 = document.querySelector('[data-swiper-bestsellers-prev]');
    var swiperNext3 = document.querySelector('[data-swiper-bestsellers-next]');
    var swiper3 = new Swiper('.swiper-bestsellers', {
      direction: 'horizontal',
      slidesPerView: 1,
      loop: true,
      breakpoints: {
...
function initSwiperCatalog() {
  if (document.querySelector('.swiper-catalog') !== null) {
    var swiperPrev4 = document.querySelector('[data-swiper-catalog-prev]');
    var swiperNext4 = document.querySelector('[data-swiper-catalog-next]');
    var swiper4 = new Swiper('.swiper-catalog', {
      direction: 'horizontal',
      slidesPerView: 1,
      loop: true,
      breakpoints: {
